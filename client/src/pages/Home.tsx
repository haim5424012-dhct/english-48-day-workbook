  ...
  return (
    <div className="app-shell">
      <header className="topbar">
        ...
        <nav className={`topnav ${mobileMenuOpen ? "is-open" : ""}`} aria-label="Điều hướng chính"><a href="#lesson" onClick={() => setMobileMenuOpen(false)}>Bài học</a><a href="/lo-trinh" onClick={() => setMobileMenuOpen(false)}>Lịch 48 ngày</a><a href="/lo-trinh#principles" onClick={() => setMobileMenuOpen(false)}>Phương pháp</a><a href="/quiz-lab" onClick={() => setMobileMenuOpen(false)}>Phòng quiz</a></nav>
