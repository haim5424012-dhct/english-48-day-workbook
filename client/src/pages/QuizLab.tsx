...
const specimens: (QuizItem | { question: string; options: string[]; correctIndex: number })[] = [
  ...
  },
  {
    ...
    leftItems: ["Who is she?", "Who is this?", "What is that?"],
    rightItems: ["It’s my grandfather.", "They are my children.", "She is my cousin."],
  ...
  },
  {
    ...
    acceptedAnswers: ["Yes, he does.", "No, he doesn't."],
    placeholder: "Yes, … / No, …",
